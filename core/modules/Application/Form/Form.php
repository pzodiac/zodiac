...
abstract class Form extends \Phalcon\Forms\Form
{
        ...
        if ($element instanceof Hidden) {
            ...
            switch (true) {
                ...
                case $element instanceof File:
                    ...
                    $html .= $this->makeLabelInline($element);
                    $html .= $element;
                    $html .= '</div>';
                    break;
    ...
    {
        if ($element->getLabel()) {
            return '<label class="control-label" for="' . $element->getName() . '">' . $this->helper->translate($element->getLabel()) . '</label>';
        } else {
            return '';
        }
    }
    ...
    {
        if ($element->getLabel()) {
            return '<label class="col-sm-2 control-label" for="' . $element->getName() . '">' . $this->helper->translate($element->getLabel()) . '</label>';
        } else {
            return '';
        }
    }
